...
# 도메인 밖 키워드 패턴 (간단 휴리스틱). chat_pipeline._OOD_RE 와 동기화(배치 경로 answer_questions 는
# rejector 만 타므로 타대학 질문이 안 걸러지면 충남대 자료로 오답 → 대학명/일반상식 키워드 넓힘).
_OUT_OF_DOMAIN_KEYWORDS = [
    "서울대", "연세대", "고려대", "카이스트", "포스텍",
    "한양대", "성균관", "경북대", "부산대", "전남대", "경희대", "중앙대", "인하대", "아주대",
    "수능", "공무원 시험", "군대", "병역",
    "주식", "암호화폐", "코인", "비트코인",
    "날씨", "주가", "환율", "로또", "운세", "연애", "여자친구", "남자친구",
]
